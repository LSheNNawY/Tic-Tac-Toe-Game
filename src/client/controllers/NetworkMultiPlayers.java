...
public class NetworkMultiPlayers implements Initializable {
    ...
    private final int yourId = Main.playerData.getId();
    ...
    public void initialize(URL location, ResourceBundle resources) {
        PlayerConnectionHandler playerConnectionHandler = new PlayerConnectionHandler(Main.playerData.getId());
    }
